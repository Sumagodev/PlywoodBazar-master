        ...
        <Text style={[customStyle.textBold,{paddingHorizontal: wp(2)}]}>Limited-Time Offer! </Text>
          <View style={{ flexDirection: 'row', paddingHorizontal: wp(2), alignItems: 'center', flexWrap:'wrap' }}>
            <Text style={{ width: '89%' }}>
              ...
              OFF our top-selling. <Text style={customStyle.textBold}> {item?.payload?.productName}</Text>{' '}for the next<Text style={customStyle.textBold}> {daysDifference}</Text>{' '}only!
