...
export default function Userprofile1(props) {
  ...
  return (
    <>
      <ScrollView style={[styles.bgwhite, {paddingBottom: 50}]} showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false}>
        ...
        <View style={{flex: 1, zIndex: 1}}>
          ...
          <View style={{flex: 1, gap: 10, alignSelf: 'center', marginTop: wp(15), zIndex: 1, position: 'absolute'}}>
            <TouchableOpacity style={{bottom: wp(-14), alignSelf: 'center'}}>
              ...
              <TouchableOpacity onPress={() => navigate.navigate('Editprofile')} style={{alignSelf: 'flex-end', top: wp(-10), height: wp(10), width: wp(10), backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center', borderRadius: 22, borderWidth: 3, borderColor: '#603200'}}>
                <FontAwesome name="pencil" size={wp(6)} color="#603200" />
              </TouchableOpacity>
            </TouchableOpacity>
          </View>
        </View>
      ...
      {userObj?.isVerified && (
        ...
        */}
          ...
          <TouchableOpacity style={[{marginTop: wp(3), alignSelf: 'center'}]}>
            <CustomButtonNew onPress={() => navigation.navigate('Supplier', {data: userObj})} text={'View Public Profile'} textSize={wp(4)} paddingHorizontal={wp(7)} paddingVertical={wp(2)} />
          </TouchableOpacity>
