    ...
    <>
      ...
      <Header normal={true} rootProps={props} />
        <View style={{position: 'relative',zIndex:1}}>
          <Image source={{uri: bannerImage && `${bannerImage}`.includes('base64') ? bannerImage : generateImageUrl(bannerImage)}} style={{height: hp(22), borderRadius:0}} resizeMode="stretch" />
          <TouchableOpacity style={[{position: 'absolute', right: 10, top: 10,height:wp(7),width:wp(7),backgroundColor:'#FFFFFF',alignItems:'center',justifyContent:'center',borderRadius:22,borderWidth:3,borderColor:'#603200'}]} onPress={() => handlePickBannerImage()}>
...
{/*
          ...
          */}
          ...
          {profileImage && `${profileImage}`.includes('base64') ? (
            ...
            <TouchableOpacity onPress={() => handlePickProfileImage()} style={{alignSelf:'flex-end',top:wp(-10),height:wp(7),width:wp(7),backgroundColor:'#FFFFFF',alignItems:'center',justifyContent:'center',borderRadius:22,borderWidth:3,borderColor:'#603200'}}>
            <FontAwesome name='pencil' size={22} color='#603200'  />
          </TouchableOpacity>
          </TouchableOpacity>
          </View>
        ...
        <Text style={[styles1.nameheading, {color:'#000',fontSize:wp(4),paddingLeft:wp(5)}]}>Name of Organization</Text>
            ...
            <View style={[styles1.card_main, {marginTop: 5, paddingVertical: 1}]}>
              <TextInput style={styles1.nameheading} onChangeText={e => setcompanyName(e)} value={companyName} />
            </View>
        ...
        {/* <View style={[styles1.card_main, {marginTop: 5}]}>
          ...
          <View>
            <View style={{width: wp(80)}}>
              ...
              <View style={[styles1.card_main, {marginTop: 5, paddingVertical: 1}]}>
              <TextInput style={styles1.nameheading}  onChangeText={setphone} value={phone}  />
            </View>
            ...
            <Pressable onPress={() => setAniversaryDateModal(true)}>
              <View  style={[styles1.card_main, {marginTop: 5, paddingVertical: 1}]}>
                <TextInput style={styles1.nameheading} onChangeText={e => setAniversaryDate(e)} value={moment(aniversaryDate).format('YYYY-MM-DD')} editable={false} placeholder="DD - MM - YYYY" />
              </View>
            </Pressable>
        ...
        {userObj?.role != ROLES_CONSTANT.USER && (
          <>
            ...
            <Text style={[styles1.nameheading, {color:'#000',fontSize:wp(4),paddingLeft:wp(5)}]}> Address</Text>
                <View style={[styles1.card_main, {marginTop: 5, paddingVertical: 1}]}>
                  <TextInput style={styles1.nameheading} value={address} onChangeText={setaddress} placeholder="Address" />
                </View>
          
                <Text style={[styles1.nameheading, {color:'#000',fontSize:wp(4),paddingLeft:wp(5)}]}>Landline</Text>
                <View style={[styles1.card_main, {marginTop: 5, paddingVertical: 1}]}>
                  <TextInput style={styles1.nameheading} value={companyPhone} onChangeText={setcompanyPhone} placeholder="Company Phone" />
                </View>
                ...
                <View style={[styles1.card_main, {marginTop: 5, paddingVertical: 1}]}>
                  <TextInput style={styles1.nameheading} value={brandNames} onChangeText={setBrandNames} placeholder="Nature Of Business" />
                </View>
          
                <Text style={[styles1.nameheading, {color:'#000',fontSize:wp(4),paddingLeft:wp(5)}]}>Role</Text>
                <View style={[styles1.card_main, {marginTop: 5, paddingVertical: 1}]}>
                  <TextInput style={styles1.nameheading} value={natureOfBusiness} onChangeText={setNatureOfBusiness} placeholder="Nature Of Business" editable={false} />
                </View>
         

                <Text style={[styles1.nameheading, {color:'#000',fontSize:wp(4),paddingLeft:wp(5)}]}>Google Maps Link</Text>
                <View style={[styles1.card_main, {marginTop: 5, paddingVertical: 1}]}>
                  <TextInput style={styles1.nameheading} value={googleMapsLink} onChangeText={setGoogleMapsLink} placeholder="Google Maps `Link" />
                </View>
       
                <Text style={[styles1.nameheading, {color:'#000',fontSize:wp(4),paddingLeft:wp(5)}]}>GST Number</Text>
                <View style={[styles1.card_main, {marginTop: 5, paddingVertical: 1}]}>
                  <TextInput style={styles1.nameheading} value={gstNumber} placeholder="GST Number"  />
              </View>
            ...
            <Text style={[styles1.nameheading, {color:'#000',fontSize:wp(4),paddingLeft:wp(5)}]}>Name of Authorised person</Text>
              <View style={[styles1.card_main, {marginTop: 5, paddingVertical: 1}]}>
                <TextInput style={styles1.nameheading} onChangeText={e => setName(e)} value={name} />
              </View>
           
    
              <Text style={[styles1.nameheading, {color:'#000',fontSize:wp(4),paddingLeft:wp(5)}]}>Email</Text>
            <View style={[styles1.card_main, {marginTop: 5, paddingVertical: 1}]}>
              <TextInput style={styles1.nameheading}  onChangeText={setemail} value={email} />
            </View>
            ...
            <View style={[styles1.card_main, {marginTop: 5, paddingVertical: 1}]}>
                <TextInput style={styles1.nameheading} onChangeText={e => setphone(e)} value={phone} editable={false} />
              </View>
      

              <Text style={[styles1.nameheading, {color:'#000',fontSize:wp(4),paddingLeft:wp(5)}]}>Whatsapp No.</Text>
              <View style={[styles1.card_main, {marginTop: 5, paddingVertical: 1}]}>
                <TextInput style={styles1.nameheading} onChangeText={e => setwhatsapp(e)} value={whatsapp} />
              </View>
            ...
            <Text style={[styles1.nameheading, {color:'#000',fontSize:wp(4),paddingLeft:wp(5)}]}>Year of Establishment</Text>
              <View style={[styles1.card_main, {marginTop: 5, paddingVertical: 1}]}>
                <TextInput style={styles1.nameheading} value={yearOfEstablishment} onChangeText={setYearOfEstablishment} placeholder="Year of Establishment" />
              </View>
                ...
                return (
                  <Pressable
                    ...
                    {el && el.image ? (
                      ...
                      <Text style={styles1.nameheading}>Please Upload Image</Text>
                    )}
                  </Pressable>
                );
              })}
                ...
                return (
                  <Pressable
                    ...
                    {el && el?.videoObj?.name ? (
                      ...
                      <Text style={styles1.nameheading}>Please Upload Video</Text>
                    )}
                  </Pressable>
                );
              })}
