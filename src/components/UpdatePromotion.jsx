            ...
            />
              ...
              />
                ...
                <Pressable
                 ...
                 <View style={{ alignSelf: 'center', marginVertical: wp(4) }}>
                <CustomButton onPress={() => handleCreatePromotion()} text={'UPDATE'} textSize={wp(3.5)} paddingHorizontal={wp(4)} paddingVertical={wp(3)} />
              </View>
