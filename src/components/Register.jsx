  ...
  return (
    <View style={{ backgroundColor: 'white'}}>
      ...
      <ScrollView contentContainerStyle={[styles.bgwhite]}>
            <ImageBackground 
      source={require('../../assets/img/wooden.jpg')}
...
{/* <View style={styles1.container}> */}
      ...
      {/* </View> */}
          ...
          <View style={[{ marginVertical: 20 ,alignItems: "center",}]}>
            ...
            <View style={{ alignSelf: "flex-end"}}><CustomRoundedTextButton buttonText={'Submit'} buttonColor={'#573C26'} onPress={() => handleSubmit()} /></View>
