            ...
            <View style={[styles1.card_main,]}>
              ...
              <TextInput
                ...
                style={{
                  ...
                  height: 100, // Set the height for the textarea
                }}
              ...
              <Pressable
                style={[styles1.dropdownStyle, { paddingVertical: wp(2.1), paddingStart: wp(2), justifyContent: 'space-between' }]}
                onPress={() => {
              ...
              <View style={{ alignSelf: 'center', marginVertical: wp(5) }}>
                <CustomButton onPress={() => handleCreatePromotion()} text={'SUBMIT'} textSize={wp(4)} paddingHorizontal={wp(4)} paddingVertical={wp(3)} />
              </View>
            </View>
          </ScrollView>
        </ImageBackground>
